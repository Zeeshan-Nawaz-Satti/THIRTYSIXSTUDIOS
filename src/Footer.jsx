    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Thirty Six Studios</h3>
            <p className="text-gray-400 mb-4">Creating stunning digital experiences through innovative design and development.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">contact@thirtysixstudios.com</li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <p className="text-center text-gray-400">
            © 2024 Thirty Six Studios. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
